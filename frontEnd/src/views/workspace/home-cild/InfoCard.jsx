...
import DoughnutChart from '../../../components/canvas/DoughnutChart';

const InfoCard = memo(
  ({ index, id, title, handleDrag, state, img, progressNumber }) => {
    ...
    return (
      ...
      >
        ...
        >
          <img src={img} style={{ width: '40px', height: '40px' }} alt='' />
          <DoughnutChart width={80} height={80} progress={progressNumber} />
        </div>
      </Card>
    );
  }
