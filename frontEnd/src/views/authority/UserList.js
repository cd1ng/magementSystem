...
import SidebarAddUser from '../../components/sidebar/SidebarAddUser'
import SidebarChangeUser from '../../components/sidebar/SidebarChangeUser'
import SidebarTrees from '../../components/sidebar/SidebarTrees'
...
const UserList = memo(() => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render:(text,record,index)=>{
        ...
        return <Switch checked={checked} disabled={disabled} onChange={(e)=>console.log(e)}/>
      }
    },
    {
      title: '操作',
      ...
      render:(text,record)=>{
        return(
          <Space size="middle" style={{display:"flex",width:"200px",justifyContent:"space-around",color:"blue"}}>
            ...
            content={
              <div>
                ...
                <Space style={{marginLeft:"40px"}}>
                  ...
                  <Button type="primary" danger onClick={()=>userDelete(record)}>是</Button>
                </Space>
              </div>
            }
            trigger="click"
  ...
  return(
    <div style={{height:"100%",overflowY:"auto"}}>
      ...
      <SidebarTrees authority={authority} setAuthority={setAuthority} checkedKeys={checkedKeys} setCheckedKeys={setCheckedKeys} itemId={itemId}/>
